...
q=m.match(/micromessenger|qqbrowser|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|trident|oupeng|opera|miuibrowser|firefox/i)||m.match(/chrome|safari/i);q&&0<q.length&&(n=q[0].toLowerCase(),"micromessenger"==n?n=c.BROWSER_TYPE_WECHAT:"safari"===n&&m.match(/android.*applewebkit/)?n=c.BROWSER_TYPE_ANDROID:"trident"==n?n=c.BROWSER_TYPE_IE:"360 aphone"==n&&(n=c.BROWSER_TYPE_360));c.browserType=n;n=m.match(/(iPad|iPhone|iPod)/i)?!0:!1;m=m.match(/android/i)||h.platform.match(/android/i)?
!0:!1;q=c.OS_UNKNOWN;-1!=h.appVersion.indexOf("Win")?q=c.OS_WINDOWS:n?q=c.OS_IOS:-1!=h.appVersion.indexOf("Mac")?q=c.OS_OSX:-1!=h.appVersion.indexOf("X11")?q=c.OS_UNIX:m?q=c.OS_ANDROID:-1!=h.appVersion.indexOf("Linux")&&(q=c.OS_LINUX);c.os=q;c._supportMultipleAudio=-1<f.indexOf(c.browserType);f=parseInt(a[b.renderMode]);m=cc._RENDER_TYPE_WEBGL;n=cc.newElement("Canvas");cc._supportRender=!0;d=!window.WebGLRenderingContext||-1==d.indexOf(c.browserType)||-1==e.indexOf(c.os);if(1===f||0===f&&d||"file://"==
location.origin)m=cc._RENDER_TYPE_CANVAS;c._canUseCanvasNewBlendModes=function(){var a=document.createElement("canvas");a.width=1;a.height=1;a=a.getContext("2d");a.fillStyle="#000";a.fillRect(0,0,1,1);a.globalCompositeOperation="multiply";var b=document.createElement("canvas");b.width=1;b.height=1;var c=b.getContext("2d");c.fillStyle="#fff";c.fillRect(0,0,1,1);a.drawImage(b,0,0,1,1);return 0===a.getImageData(0,0,1,1).data[0]};c._supportCanvasNewBlendModes=c._canUseCanvasNewBlendModes();m!=cc._RENDER_TYPE_WEBGL||
g.WebGLRenderingContext&&cc.create3DContext(n,{stencil:!0,preserveDrawingBuffer:!0})||(0==f?m=cc._RENDER_TYPE_CANVAS:cc._supportRender=!1);if(m==cc._RENDER_TYPE_CANVAS)try{n.getContext("2d")}catch(r){cc._supportRender=!1}cc._renderType=m;try{c._supportWebAudio=!!(g.AudioContext||g.webkitAudioContext||g.mozAudioContext)}catch(t){c._supportWebAudio=!1}try{var u=c.localStorage=g.localStorage;u.setItem("storage","");u.removeItem("storage");u=null}catch(s){"SECURITY_ERR"!==s.name&&"QuotaExceededError"!==
s.name||cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option"),c.localStorage=function(){}}u=c.capabilities={canvas:!0};cc._renderType==cc._RENDER_TYPE_WEBGL&&(u.opengl=!0);if(void 0!==k.ontouchstart||h.msPointerEnabled)u.touches=!0;void 0!==k.onmouseup&&(u.mouse=!0);void 0!==k.onkeyup&&(u.keyboard=!0);if(g.DeviceMotionEvent||g.DeviceOrientationEvent)u.accelerometer=!0;c.garbageCollect=function(){};c.dumpRoot=function(){};c.restartVM=function(){};c.cleanScript=
function(a){};c.dump=function(){var a;a=""+("isMobile : "+this.isMobile+"\r\n");a+="language : "+this.language+"\r\n";a+="browserType : "+this.browserType+"\r\n";a+="capabilities : "+JSON.stringify(this.capabilities)+"\r\n";a+="os : "+this.os+"\r\n";a+="platform : "+this.platform+"\r\n";cc.log(a)}};cc.ORIENTATION_PORTRAIT=0;cc.ORIENTATION_PORTRAIT_UPSIDE_DOWN=1;cc.ORIENTATION_LANDSCAPE_LEFT=2;cc.ORIENTATION_LANDSCAPE_RIGHT=3;cc._drawingUtil=null;cc._renderContext=null;cc._canvas=null;
cc._gameDiv=null;cc._rendererInitialized=!1;cc._setupCalled=!1;
...
Object.defineProperty(d.prototype,"constructor",h);this.__getters__&&(d.__getters__=cc.clone(this.__getters__));this.__setters__&&(d.__setters__=cc.clone(this.__setters__));for(var k=0,m=arguments.length;k<m;++k){var n=arguments[k],q;for(q in n){var r="function"===typeof n[q],t="function"===typeof e[q],u=a.test(n[q]);b&&r&&t&&u?(h.value=ClassManager.compileSuper(n[q],q,g),Object.defineProperty(f,q,h)):r&&t&&u?(h.value=function(a,b){return function(){var c=this._super;this._super=e[a];var d=b.apply(this,
arguments);this._super=c;return d}}(q,n[q]),Object.defineProperty(f,q,h)):r?(h.value=n[q],Object.defineProperty(f,q,h)):f[q]=n[q];if(r){var s,v;if(this.__getters__&&this.__getters__[q]){var r=this.__getters__[q],w;for(w in this.__setters__)if(this.__setters__[w]==r){v=w;break}cc.defineGetterSetter(f,r,n[q],n[v]?n[v]:f[v],q,v)}if(this.__setters__&&this.__setters__[q]){r=this.__setters__[q];for(w in this.__getters__)if(this.__getters__[w]==r){s=w;break}cc.defineGetterSetter(f,r,n[s]?n[s]:f[s],n[q],
s,q)}}}}d.extend=cc.Class.extend;d.implement=function(a){for(var b in a)f[b]=a[b]};return d}})();
...
new cc.ResolutionPolicy(b.EQUAL_TO_FRAME,c.FIXED_HEIGHT);this._rpFixedWidth=new cc.ResolutionPolicy(b.EQUAL_TO_FRAME,c.FIXED_WIDTH);this._hDC=cc._canvas;this._hRC=cc._renderContext;this._targetDensityDPI=cc.DENSITYDPI_HIGH},_resizeEvent:function(){var a=this._originalDesignResolutionSize.width,b=this._originalDesignResolutionSize.height;this._resizeCallback&&(this._initFrameSize(),this._resizeCallback.call());0<a&&this.setDesignResolutionSize(a,b,this._resolutionPolicy)},setTargetDensityDPI:function(a){this._targetDensityDPI=
a;this._setViewPortMeta()},getTargetDensityDPI:function(){return this._targetDensityDPI},resizeWithBrowserSize:function(a){a?this.__resizeWithBrowserSize||(this.__resizeWithBrowserSize=!0,a=this._resizeEvent.bind(this),cc._addEventListener(window,"resize",a,!1)):this.__resizeWithBrowserSize&&(this.__resizeWithBrowserSize=!0,a=this._resizeEvent.bind(this),window.removeEventListener("resize",a,!1))},setResizeCallback:function(a){if(cc.isFunction(a)||null==a)this._resizeCallback=a},_initFrameSize:function(){var a=
this._frameSize;a.width=cc.__BrowserGetter.availWidth(this._frame);a.height=cc.__BrowserGetter.availHeight(this._frame)},_adjustSizeKeepCanvasSize:function(){var a=this._originalDesignResolutionSize.width,b=this._originalDesignResolutionSize.height;0<a&&this.setDesignResolutionSize(a,b,this._resolutionPolicy)},_setViewPortMeta:function(){if(this._isAdjustViewPort){var a=document.getElementById("cocosMetaElement");a&&document.head.removeChild(a);var b,c=(a=document.getElementsByName("viewport"))?a[0]:
null,d,a=cc.newElement("meta");a.id="cocosMetaElement";a.name="viewport";a.content="";b=cc.__BrowserGetter.meta;d=c?c.content:"";for(var e in b)RegExp(e).test(d)||(d+=","+e+"\x3d"+b[e]);/^,/.test(d)&&(d=d.substr(1));a.content=d;c&&(c.content=d);document.head.appendChild(a)}},_setScaleXYForRenderTexture:function(){var a=cc.contentScaleFactor();this._scaleY=this._scaleX=a},_resetScale:function(){this._scaleX=this._originalScaleX;this._scaleY=this._originalScaleY},_adjustSizeToBrowser:function(){},initialize:function(){this._initialized=
...
this._designResolutionSize.height=b;var d=c.apply(this,this._designResolutionSize);d.scale&&2==d.scale.length&&(this._scaleX=d.scale[0],this._scaleY=d.scale[1]);d.viewport&&(a=this._viewPortRect,b=this._visibleRect,d=d.viewport,a.x=d.x,a.y=d.y,a.width=d.width,a.height=d.height,b.x=-a.x/this._scaleX,b.y=-a.y/this._scaleY,b.width=cc._canvas.width/this._scaleX,b.height=cc._canvas.height/this._scaleY);a=cc.director;a._winSizeInPoints.width=this._designResolutionSize.width;a._winSizeInPoints.height=this._designResolutionSize.height;
...
convertToLocationInView:function(a,b,c){return{x:this._devicePixelRatio*(a-c.left),y:this._devicePixelRatio*(c.top+c.height-b)}},_convertMouseToLocationInView:function(a,b){var c=this._viewPortRect;a.x=(this._devicePixelRatio*(a.x-b.left)-c.x)/this._scaleX;a.y=(this._devicePixelRatio*(b.top+b.height-a.y)-c.y)/this._scaleY},_convertTouchesWithScale:function(a){for(var b=this._viewPortRect,c=this._scaleX,d=this._scaleY,e,f,g,h=0;h<a.length;h++)e=a[h],f=e._point,g=e._prevPoint,e._setPoint((f.x-b.x)/
c,(f.y-b.y)/d),e._setPrevPoint((g.x-b.x)/c,(g.y-b.y)/d)}});cc.EGLView._getInstance=function(){this._instance||(this._instance=this._instance||new cc.EGLView,this._instance.initialize());return this._instance};
...
g.x=m.x;g.y=m.y;c.push(e)}return c},registerSystemEvent:function(a){if(!this._isRegisterEvent){this._glView=cc.view;var b=this,c="touches"in cc.sys.capabilities;"mouse"in cc.sys.capabilities&&(cc._addEventListener(window,"mousedown",function(){b._mousePressed=!0},!1),cc._addEventListener(window,"mouseup",function(c){var d=b._mousePressed;b._mousePressed=!1;if(d){var d=b.getHTMLElementPosition(a),e=b.getPointByEvent(c,d);cc.rectContainsPoint(new cc.Rect(d.left,d.top,d.width,d.height),e)||(b.handleTouchesEnd([b.getTouchByXY(e.x,
e.y,d)]),d=b.getMouseEvent(e,d,cc.EventMouse.UP),d.setButton(c.button),cc.eventManager.dispatchEvent(d))}},!1),cc._addEventListener(a,"mousedown",function(c){b._mousePressed=!0;var d=b.getHTMLElementPosition(a),e=b.getPointByEvent(c,d);b.handleTouchesBegin([b.getTouchByXY(e.x,e.y,d)]);d=b.getMouseEvent(e,d,cc.EventMouse.DOWN);d.setButton(c.button);cc.eventManager.dispatchEvent(d);c.stopPropagation();c.preventDefault();a.focus()},!1),cc._addEventListener(a,"mouseup",function(c){b._mousePressed=!1;
var d=b.getHTMLElementPosition(a),e=b.getPointByEvent(c,d);b.handleTouchesEnd([b.getTouchByXY(e.x,e.y,d)]);d=b.getMouseEvent(e,d,cc.EventMouse.UP);d.setButton(c.button);cc.eventManager.dispatchEvent(d);c.stopPropagation();c.preventDefault()},!1),cc._addEventListener(a,"mousemove",function(c){var d=b.getHTMLElementPosition(a),e=b.getPointByEvent(c,d);b.handleTouchesMove([b.getTouchByXY(e.x,e.y,d)]);d=b.getMouseEvent(e,d,cc.EventMouse.MOVE);b._mousePressed?d.setButton(c.button):d.setButton(null);cc.eventManager.dispatchEvent(d);
...
cc.pSubIn=function(a,b){a.x-=b.x;a.y-=b.y};cc.pAddIn=function(a,b){a.x+=b.x;a.y+=b.y};cc.pNormalizeIn=function(a){cc.pMultIn(a,1/Math.sqrt(a.x*a.x+a.y*a.y))};cc.vertexLineToPolygon=function(a,b,c,d,e){e+=d;if(!(1>=e)){b*=0.5;for(var f,g=e-1,h=d;h<e;h++){f=2*h;var k=cc.p(a[2*h],a[2*h+1]),m;if(0===h)m=cc.pPerp(cc.pNormalize(cc.pSub(k,cc.p(a[2*(h+1)],a[2*(h+1)+1]))));else if(h===g)m=cc.pPerp(cc.pNormalize(cc.pSub(cc.p(a[2*(h-1)],a[2*(h-1)+1]),k)));else{m=cc.p(a[2*(h-1)],a[2*(h-1)+1]);var n=cc.p(a[2*(h+1)],a[2*(h+1)+1]),q=cc.pNormalize(cc.pSub(n,k)),r=cc.pNormalize(cc.pSub(m,k)),t=Math.acos(cc.pDot(q,r));m=t<cc.degreesToRadians(70)?cc.pPerp(cc.pNormalize(cc.pMidpoint(q,
r))):t<cc.degreesToRadians(170)?cc.pNormalize(cc.pMidpoint(q,r)):cc.pPerp(cc.pNormalize(cc.pSub(n,m)))}m=cc.pMult(m,b);c[2*f]=k.x+m.x;c[2*f+1]=k.y+m.y;c[2*(f+1)]=k.x-m.x;c[2*(f+1)+1]=k.y-m.y}for(h=0==d?0:d-1;h<g;h++)f=2*h,a=f+2,b=cc.vertex2(c[2*f],c[2*f+1]),e=cc.vertex2(c[2*(f+1)],c[2*(f+1)+1]),f=cc.vertex2(c[2*a],c[2*a]),d=cc.vertex2(c[2*(a+1)],c[2*(a+1)+1]),b=!cc.vertexLineIntersect(b.x,b.y,d.x,d.y,e.x,e.y,f.x,f.y),!b.isSuccess&&(0>b.value||1<b.value)&&(b.isSuccess=!0),b.isSuccess&&(c[2*a]=d.x,
...
1:d;b=b||this._currentID;var e=this._cacheToCanvasCmds[b],f,g;f=0;for(g=e.length;f<g;f++)e[f].rendering(a,c,d);e.length=0;a=this._cacheInstanceIds;delete this._cacheToCanvasCmds[b];cc.arrayRemoveObject(a,b);0===a.length?this._isCacheToCanvasOn=!1:this._currentID=a[a.length-1]},_turnToCacheMode:function(a){this._isCacheToCanvasOn=!0;a=a||0;this._cacheToCanvasCmds[a]=[];this._cacheInstanceIds.push(a);this._currentID=a},_turnToNormalMode:function(){this._isCacheToCanvasOn=!1},resetFlag:function(){this.childrenOrderDirty=
!1;this._transformNodePool.length=0},transform:function(){var a=this._transformNodePool;a.sort(this._sortNodeByLevelAsc);for(var b=0,c=a.length;b<c;b++)a[b]._renderCmdDiry&&a[b]._transformForRenderer();a.length=0},transformDirty:function(){return 0<this._transformNodePool.length},_sortNodeByLevelAsc:function(a,b){return a._curLevel-b._curLevel},pushDirtyNode:function(a){this._transformNodePool.push(a)},clearRenderCommands:function(){this._renderCmds.length=0},pushRenderCommand:function(a){if(this._isCacheToCanvasOn){var b=
this._cacheToCanvasCmds[this._currentID];-1===b.indexOf(a)&&b.push(a)}else-1===this._renderCmds.indexOf(a)&&this._renderCmds.push(a)}},cc.renderer=cc.rendererCanvas,cc.TextureRenderCmdCanvas=function(a){this._node=a;this._textureCoord={renderX:0,renderY:0,x:0,y:0,width:0,height:0,validRect:!1}},cc.TextureRenderCmdCanvas.prototype.rendering=function(a,b,c){var d=this._node;a=a||cc._renderContext;var e=this._textureCoord;if(!d._texture||0!==e.width&&0!==e.height)if(e.validRect||0!==d._displayedOpacity)if(!d._texture||
d._texture._isLoaded){var f=d._transformWorld,g=d._offsetPosition.x,h=-d._offsetPosition.y-d._rect.height,k=d._rect.width,m=d._rect.height,n,q="source-over"!==d._blendFuncStr;n=d._displayedOpacity/255;1!==f.a||0!==f.b||0!==f.c||1!==f.d||d._flippedX||d._flippedY?(a.save(),a.globalAlpha=n,a.transform(f.a,f.c,f.b,f.d,f.tx*b,-f.ty*c),q&&(a.globalCompositeOperation=d._blendFuncStr),d._flippedX&&(g=-g-k,a.scale(-1,1)),d._flippedY&&(h=d._offsetPosition.y,a.scale(1,-1)),d._texture?(n=d._texture._htmlElementObj,
""!=d._texture._pattern?(a.save(),a.fillStyle=a.createPattern(n,d._texture._pattern),a.fillRect(g*b,h*c,k*b,m*c),a.restore()):d._colorized?a.drawImage(n,0,0,e.width,e.height,g*b,h*c,k*b,m*c):a.drawImage(n,e.renderX,e.renderY,e.width,e.height,g*b,h*c,k*b,m*c)):(k=d._contentSize,e.validRect&&(d=d._displayedColor,a.fillStyle="rgba("+d.r+","+d.g+","+d.b+",1)",a.fillRect(g*b,h*c,k.width*b,k.height*c))),a.restore()):(q&&(a.save(),a.globalCompositeOperation=d._blendFuncStr),a.globalAlpha=n,d._texture?(n=
d._texture.getHtmlElementObj(),""!=d._texture._pattern?(a.save(),a.transform(f.a,f.c,f.b,f.d,f.tx*b,-f.ty*c),a.fillStyle=a.createPattern(n,d._texture._pattern),a.fillRect(g*b,h*c,k*b,m*c),a.restore()):d._colorized?a.drawImage(n,0,0,e.width,e.height,(f.tx+g)*b,(-f.ty+h)*c,k*b,m*c):a.drawImage(n,e.renderX,e.renderY,e.width,e.height,(f.tx+g)*b,(-f.ty+h)*c,k*b,m*c)):(k=d._contentSize,e.validRect&&(d=d._displayedColor,a.fillStyle="rgba("+d.r+","+d.g+","+d.b+",1)",a.fillRect((f.tx+g)*b,(-f.ty+h)*c,k.width*
b,k.height*c))),q&&a.restore());cc.g_NumberOfDraws++}},cc.RectRenderCmdCanvas=function(a){this._node=a},cc.RectRenderCmdCanvas.prototype.rendering=function(a,b,c){a=a||cc._renderContext;var d=this._node,e=d._transformWorld,f=d._displayedColor,g=d._displayedOpacity/255,h=d._contentSize.width,k=d._contentSize.height;if(0!==g){var m=1!==e.a||0!==e.b||0!==e.c||1!==e.d,n="source-over"!==d._blendFuncStr||m;n&&(a.save(),a.globalCompositeOperation=d._blendFuncStr);a.globalAlpha=g;a.fillStyle="rgba("+(0|f.r)+
","+(0|f.g)+","+(0|f.b)+", 1)";m?(a.transform(e.a,e.c,e.b,e.d,e.tx*b,-e.ty*c),a.fillRect(0,0,h*b,-k*c)):a.fillRect(e.tx*b,-e.ty*c,h*b,-k*c);n&&a.restore();cc.g_NumberOfDraws++}},cc.GradientRectRenderCmdCanvas=function(a){this._node=a;this._startPoint=cc.p(0,0);this._endPoint=cc.p(0,0);this._endStopStr=this._startStopStr=null},cc.GradientRectRenderCmdCanvas.prototype.rendering=function(a,b,c){a=a||cc._renderContext;var d=this._node,e=d._displayedOpacity/255,f=d._transformWorld;if(0!==e){var g=1!==
f.a||0!==f.b||0!==f.c||1!==f.d,h="source-over"!==d._blendFuncStr||g;h&&(a.save(),a.globalCompositeOperation=d._blendFuncStr);a.globalAlpha=e;var e=d._contentSize.width,d=d._contentSize.height,k=a.createLinearGradient(this._startPoint.x,this._startPoint.y,this._endPoint.x,this._endPoint.y);k.addColorStop(0,this._startStopStr);k.addColorStop(1,this._endStopStr);a.fillStyle=k;g?(a.transform(f.a,f.c,f.b,f.d,f.tx*b,-f.ty*c),a.fillRect(0,0,e*b,-d*c)):a.fillRect(f.tx*b,-f.ty*c,e*b,-d*c);h&&a.restore();cc.g_NumberOfDraws++}},
cc.ParticleRenderCmdCanvas=function(a){this._node=a},cc.ParticleRenderCmdCanvas.prototype.rendering=function(a,b,c){a=a||cc._renderContext;var d=this._node,e=d._transformWorld,f=d._pointRect;a.save();a.transform(e.a,e.c,e.b,e.d,e.tx*b,-e.ty*c);d.isBlendAdditive()?a.globalCompositeOperation="lighter":a.globalCompositeOperation="source-over";var g,e=this._node.particleCount,h=this._node._particles;if(d.drawMode==cc.ParticleSystem.TEXTURE_MODE){if(!d._texture||!d._texture._isLoaded){a.restore();return}d=
d._texture.getHtmlElementObj();if(!d.width||!d.height){a.restore();return}var k=cc.textureCache,m=d;for(b=0;b<e;b++)if(c=h[b],g=c.color.a/255,0!==g){a.globalAlpha=g;a.save();a.translate(0|c.drawPos.x,-(0|c.drawPos.y));var n=4*Math.floor(c.size/4);g=f.width;var q=f.height;a.scale(Math.max(1/g*n,1E-6),Math.max(1/q*n,1E-6));c.rotation&&a.rotate(cc.degreesToRadians(c.rotation));c.isChangeColor&&(n=k.getTextureColors(d))&&(n.tintCache||(n.tintCache=cc.newElement("canvas"),n.tintCache.width=d.width,n.tintCache.height=
d.height),cc.generateTintImage(d,n,c.color,this._pointRect,n.tintCache),m=n.tintCache);a.drawImage(m,-(0|g/2),-(0|q/2));a.restore()}}else for(k=cc._drawingUtil,b=0;b<e;b++)c=h[b],f=0|0.5*c.size,g=c.color.a/255,0!==g&&(a.globalAlpha=g,a.save(),a.translate(0|c.drawPos.x,-(0|c.drawPos.y)),d.shapeType==cc.ParticleSystem.STAR_SHAPE?(c.rotation&&a.rotate(cc.degreesToRadians(c.rotation)),k.drawStar(a,f,c.color)):k.drawColorBall(a,f,c.color),a.restore());a.restore();cc.g_NumberOfDraws++},cc.ProgressRenderCmdCanvas=
function(a){this._PI180=Math.PI/180;this._node=a;this._sprite=null;this._type=cc.ProgressTimer.TYPE_RADIAL;this._barRect=cc.rect(0,0,0,0);this._origin=cc.p(0,0);this._radius=0;this._endAngle=this._startAngle=270;this._counterClockWise=!1},cc.ProgressRenderCmdCanvas.prototype.rendering=function(a,b,c){a=a||cc._renderContext;var d=this._node,e=this._sprite,f=e._rendererCmd._textureCoord,g=e._displayedOpacity/255;if(0!==f.width&&0!==f.height&&e._texture&&f.validRect&&0!==g){d=d._transformWorld;a.save();
a.transform(d.a,d.c,d.b,d.d,d.tx*b,-d.ty*c);"source-over"!=e._blendFuncStr&&(a.globalCompositeOperation=e._blendFuncStr);a.globalAlpha=g;var h=e._rect,k=e._offsetPosition,g=e._drawSize_Canvas,d=0|k.x,m=-k.y-h.height;g.width=h.width*b;g.height=h.height*c;e._flippedX&&(d=-k.x-h.width,a.scale(-1,1));e._flippedY&&(m=k.y,a.scale(1,-1));d*=b;m*=c;this._type==cc.ProgressTimer.TYPE_BAR?(h=this._barRect,a.beginPath(),a.rect(h.x*b,h.y*c,h.width*b,h.height*c),a.clip(),a.closePath()):this._type==cc.ProgressTimer.TYPE_RADIAL&&
(b*=this._origin.x,h=this._origin.y*c,a.beginPath(),a.arc(b,h,this._radius*c,this._PI180*this._startAngle,this._PI180*this._endAngle,this._counterClockWise),a.lineTo(b,h),a.clip(),a.closePath());c=e._texture.getHtmlElementObj();e._colorized?a.drawImage(c,0,0,f.width,f.height,d,m,g.width,g.height):a.drawImage(c,f.renderX,f.renderY,f.width,f.height,d,m,g.width,g.height);a.restore();cc.g_NumberOfDraws++}},cc.DrawNodeRenderCmdCanvas=function(a){this._node=a;this._blendFunc=this._drawColor=this._buffer=
null},cc.DrawNodeRenderCmdCanvas.prototype.rendering=function(a,b,c){var d=a||cc._renderContext,e=this._node,f=e._displayedOpacity/255;if(0!==f){d.globalAlpha=f;e=e._transformWorld;d.save();a.transform(e.a,e.c,e.b,e.d,e.tx*b,-e.ty*c);this._blendFunc&&this._blendFunc.src==cc.SRC_ALPHA&&this._blendFunc.dst==cc.ONE&&(d.globalCompositeOperation="lighter");a=this._buffer;e=0;for(f=a.length;e<f;e++){var g=a[e];switch(g.type){case cc.DrawNode.TYPE_DOT:this._drawDot(d,g,b,c);break;case cc.DrawNode.TYPE_SEGMENT:this._drawSegment(d,
g,b,c);break;case cc.DrawNode.TYPE_POLY:this._drawPoly(d,g,b,c)}}d.restore()}},cc.DrawNodeRenderCmdCanvas.prototype._drawDot=function(a,b,c,d){var e=b.fillColor,f=b.verts[0];b=b.lineWidth;a.fillStyle="rgba("+(0|e.r)+","+(0|e.g)+","+(0|e.b)+","+e.a/255+")";a.beginPath();a.arc(f.x*c,-f.y*d,b*c,0,2*Math.PI,!1);a.closePath();a.fill()},cc.DrawNodeRenderCmdCanvas.prototype._drawSegment=function(a,b,c,d){var e=b.lineColor,f=b.verts[0],g=b.verts[1],h=b.lineWidth;b=b.lineCap;a.strokeStyle="rgba("+(0|e.r)+
","+(0|e.g)+","+(0|e.b)+","+e.a/255+")";a.lineWidth=h*c;a.beginPath();a.lineCap=b;a.moveTo(f.x*c,-f.y*d);a.lineTo(g.x*c,-g.y*d);a.stroke()},cc.DrawNodeRenderCmdCanvas.prototype._drawPoly=function(a,b,c,d){var e=b.verts,f=b.lineCap,g=b.fillColor,h=b.lineWidth,k=b.lineColor,m=b.isClosePolygon,n=b.isFill;b=b.isStroke;if(null!=e){var q=e[0];a.lineCap=f;g&&(a.fillStyle="rgba("+(0|g.r)+","+(0|g.g)+","+(0|g.b)+","+g.a/255+")");h&&(a.lineWidth=h*c);k&&(a.strokeStyle="rgba("+(0|k.r)+","+(0|k.g)+","+(0|k.b)+
","+k.a/255+")");a.beginPath();a.moveTo(q.x*c,-q.y*d);f=1;for(g=e.length;f<g;f++)a.lineTo(e[f].x*c,-e[f].y*d);m&&a.closePath();n&&a.fill();b&&a.stroke()}},cc.ClippingNodeSaveRenderCmdCanvas=function(a){this._node=a},cc.ClippingNodeSaveRenderCmdCanvas.prototype.rendering=function(a,b,c){var d=this._node;a=a||cc._renderContext;d._clipElemType?(b=cc.ClippingNode._getSharedCache(),c=a.canvas,b.width=c.width,b.height=c.height,b.getContext("2d").drawImage(c,0,0),a.save()):(d.transform(),d=d._transformWorld,
a.save(),a.save(),a.transform(d.a,d.c,d.b,d.d,d.tx*b,-d.ty*c))},cc.ClippingNodeClipRenderCmdCanvas=function(a){this._node=a},cc.ClippingNodeClipRenderCmdCanvas.prototype.rendering=function(a,b,c){var d=this._node;a=a||cc._renderContext;d._clipElemType?(a.globalCompositeOperation=d.inverted?"destination-out":"destination-in",d=d._transformWorld,a.transform(d.a,d.c,d.b,d.d,d.tx*b,-d.ty*c)):(a.restore(),d.inverted&&(b=a.canvas,a.save(),a.setTransform(1,0,0,1,0,0),a.moveTo(0,0),a.lineTo(0,b.height),a.lineTo(b.width,
b.height),a.lineTo(b.width,0),a.lineTo(0,0),a.restore()),a.clip())},cc.ClippingNodeRestoreRenderCmdCanvas=function(a){this._node=a},cc.ClippingNodeRestoreRenderCmdCanvas.prototype.rendering=function(a,b,c){b=this._node;c=cc.ClippingNode._getSharedCache();a=a||cc._renderContext;b._clipElemType&&(a.restore(),a.save(),a.setTransform(1,0,0,1,0,0),a.globalCompositeOperation="destination-over",a.drawImage(c,0,0));a.restore()},cc.PhysicsDebugNodeRenderCmdCanvas=function(a){this._node=a;this._buffer=a._buffer},
...
f=-e,g=this._scaleX,h=this._scaleY;this._ignoreAnchorPointForPosition&&(a+=c,b+=e);var k=1,m=0,n=1,q=0;if(0!==this._rotationX||0!==this._rotationY)k=Math.cos(-this._rotationRadiansX),m=Math.sin(-this._rotationRadiansX),n=Math.cos(-this._rotationRadiansY),q=Math.sin(-this._rotationRadiansY);var r=this._skewX||this._skewY;r||0===c&&0===e||(a+=n*d*g+-m*f*h,b+=q*d*g+k*f*h);var t=this._transform;t.a=n*g;t.b=q*g;t.c=-m*h;t.d=k*h;t.tx=a;t.ty=b;r&&(t=cc.affineTransformConcat({a:1,b:Math.tan(cc.degreesToRadians(this._skewY)),
c:Math.tan(cc.degreesToRadians(this._skewX)),d:1,tx:0,ty:0},t),0!==c||0!==e)&&(t=cc.affineTransformTranslate(t,d,f));this._additionalTransformDirty&&(t=cc.affineTransformConcat(t,this._additionalTransform),this._additionalTransformDirty=!1);this._transform=t;this._transformDirty=!1}return this._transform},_updateColor:function(){},getOpacity:function(){return this._realOpacity},getDisplayedOpacity:function(){return this._displayedOpacity},setOpacity:function(a){this._displayedOpacity=this._realOpacity=
...
b[a],0>c._localZOrder)c.visit();else break;for(this._rendererCmd&&cc.renderer.pushRenderCommand(this._rendererCmd);a<d;a++)b[a].visit()}else this._rendererCmd&&cc.renderer.pushRenderCommand(this._rendererCmd);this._cacheDirty=!1}},_p._transformForRenderer=function(){var a=this.getNodeToParentTransform(),b=this._transformWorld;if(this._parent){var c=this._parent._transformWorld;b.a=a.a*c.a+a.b*c.c;b.b=a.a*c.b+a.b*c.d;b.c=a.c*c.a+a.d*c.c;b.d=a.c*c.b+a.d*c.d;var d=this._parent._transform,e=-(d.b+d.c)*
a.tx;b.tx=a.tx*c.a+a.ty*c.c+c.tx+-(d.b+d.c)*a.ty;b.ty=a.tx*c.b+a.ty*c.d+c.ty+e}else b.a=a.a,b.b=a.b,b.c=a.c,b.d=a.d,b.tx=a.tx,b.ty=a.ty;this._renderCmdDiry=!1;if(this._children&&0!==this._children.length)for(c=this._children,a=0,b=c.length;a<b;a++)c[a]._transformForRenderer()},_p.transform=function(a){a=this.getNodeToParentTransform();var b=this._transformWorld;if(this._parent){var c=this._parent._transformWorld;b.a=a.a*c.a+a.b*c.c;b.b=a.a*c.b+a.b*c.d;b.c=a.c*c.a+a.d*c.c;b.d=a.c*c.b+a.d*c.d;var d=
this._parent._transform,e=-(d.b+d.c)*a.tx;b.tx=a.tx*c.a+a.ty*c.c+c.tx+-(d.b+d.c)*a.ty;b.ty=a.tx*c.b+a.ty*c.d+c.ty+e}else b.a=a.a,b.b=a.b,b.c=a.c,b.d=a.d,b.tx=a.tx,b.ty=a.ty},_p.getNodeToParentTransform=function(){if(this._usingNormalizedPosition&&this._parent){var a=this._parent._contentSize;this._position.x=this._normalizedPosition.x*a.width;this._position.y=this._normalizedPosition.y*a.height;this._normalizedPositionDirty=!1}if(this._transformDirty){a=this._transform;a.tx=this._position.x;a.ty=
this._position.y;var b=1,c=0;this._rotationX&&(b=Math.cos(this._rotationRadiansX),c=Math.sin(this._rotationRadiansX));a.a=a.d=b;a.b=-c;a.c=c;var d=this._scaleX,e=this._scaleY,f=this._anchorPointInPoints.x,g=this._anchorPointInPoints.y,h=1E-6>d&&-1E-6<d?1E-6:d,k=1E-6>e&&-1E-6<e?1E-6:e;if(this._skewX||this._skewY){var m=Math.tan(-this._skewX*Math.PI/180),n=Math.tan(-this._skewY*Math.PI/180);Infinity===m&&(m=99999999);Infinity===n&&(n=99999999);var q=g*m*h,r=f*n*k;a.a=b+-c*n;a.b=b*m+-c;a.c=c+b*n;a.d=
c*m+b;a.tx+=b*q+-c*r;a.ty+=c*q+b*r}if(1!==d||1!==e)a.a*=h,a.c*=h,a.b*=k,a.d*=k;a.tx+=b*-f*h+-c*g*k;a.ty-=c*-f*h+b*g*k;this._ignoreAnchorPointForPosition&&(a.tx+=f,a.ty+=g);this._additionalTransformDirty&&(this._transform=cc.affineTransformConcat(a,this._additionalTransform),this._additionalTransformDirty=!1);this._transformDirty=!1}return this._transform},_p=null):(cc.assert(cc.isFunction(cc._tmp.WebGLCCNode),cc._LogInfos.MissingFile,"BaseNodesWebGL.js"),cc._tmp.WebGLCCNode(),delete cc._tmp.WebGLCCNode);
...
!0;this._isBaked=!1;this._cacheDirty=!0;this._cachedParent=null;for(var a=this._children,b=0,c=a.length;b<c;b++)a[b]._setCachedParent(null)}};p.addChild=function(a,b,c){cc.Node.prototype.addChild.call(this,a,b,c);a._parent==this&&this._isBaked&&a._setCachedParent(this)};p._bakeRendering=function(){if(this._cacheDirty){var a=this._children,b=this._bakeSprite;this._transformForRenderer();var c=this._getBoundingBoxForBake();c.width=0|c.width+0.5;c.height=0|c.height+0.5;var d=b.getCacheContext();b.resetCanvasSize(c.width,
c.height);d.translate(0-c.x,c.height+c.y);var e=cc.affineTransformInvert(this._transformWorld);d.transform(e.a,e.c,e.b,e.d,e.tx,-e.ty);e=b.getAnchorPointInPoints();b.setPosition(e.x+c.x,e.y+c.y);this.sortAllChildren();cc.renderer._turnToCacheMode(this.__instanceId);c=0;for(e=a.length;c<e;c++)a[c].visit(d);cc.renderer._renderingToCacheCanvas(d,this.__instanceId);b.transform();this._cacheDirty=!1}};p.visit=function(a){if(this._isBaked){a=a||cc._renderContext;var b=this._children.length;this._visible&&
...
if(a&&a._color){var b=this._displayedColor;a._color.r=b.r;a._color.g=b.g;a._color.b=b.b;a._color.a=this._displayedOpacity/255}},_p.draw=function(a){a=a||cc._renderContext;var b=cc.view,c=this._displayedColor;a.fillStyle="rgba("+(0|c.r)+","+(0|c.g)+","+(0|c.b)+","+this._displayedOpacity/255+")";a.fillRect(0,0,this.width*b.getScaleX(),-this.height*b.getScaleY());cc.g_NumberOfDraws++},_p._bakeRendering=function(){if(this._cacheDirty){var a=this._bakeSprite,b=this._children,c=b.length,d;d=this._getBoundingBoxForBake();
d.width|=0;d.height|=0;var e=a.getCacheContext();a.resetCanvasSize(d.width,d.height);var f=a.getAnchorPointInPoints(),g=this._position;if(this._ignoreAnchorPointForPosition)e.translate(0-d.x+g.x,d.height+d.y-g.y),a.setPosition(f.x+d.x-g.x,f.y+d.y-g.y);else{var h=this.getAnchorPointInPoints(),k=g.x-h.x,g=g.y-h.y;e.translate(0-d.x+k,d.height+d.y-g);a.setPosition(f.x+d.x-k,f.y+d.y-g)}d=cc.affineTransformInvert(this._transformWorld);e.transform(d.a,d.c,d.b,d.d,d.tx,-d.ty);cc.renderer._turnToCacheMode(this.__instanceId);
if(0<c){this.sortAllChildren();for(d=0;d<c;d++)if(f=b[d],0>f._localZOrder)f.visit(e);else break;for(this._rendererCmd&&cc.renderer.pushRenderCommand(this._rendererCmd);d<c;d++)b[d].visit(e)}else this._rendererCmd&&cc.renderer.pushRenderCommand(this._rendererCmd);cc.renderer._renderingToCacheCanvas(e,this.__instanceId);a.transform();this._cacheDirty=!1}},_p.visit=function(a){this._isBaked?(a=a||cc._renderContext,this._visible&&(this.transform(a),this._bakeRenderCmd&&cc.renderer.pushRenderCommand(this._bakeRenderCmd),
this._bakeSprite.visit(a))):cc.Node.prototype.visit.call(this,a)},_p._getBoundingBoxForBake=function(){var a=cc.rect(0,0,this._contentSize.width,this._contentSize.height),b=this.getNodeToWorldTransform(),a=cc.rectApplyAffineTransform(a,this.getNodeToWorldTransform());if(!this._children||0===this._children.length)return a;for(var c=this._children,d=0;d<c.length;d++){var e=c[d];e&&e._visible&&(e=e._getBoundingBoxToCurrentNode(b),a=cc.rectUnion(a,e))}return a},_p=null):(cc.assert(cc.isFunction(cc._tmp.WebGLLayerColor),
cc._LogInfos.MissingFile,"CCLayerWebGL.js"),cc._tmp.WebGLLayerColor(),delete cc._tmp.WebGLLayerColor);cc.assert(cc.isFunction(cc._tmp.PrototypeLayerColor),cc._LogInfos.MissingFile,"CCLayerPropertyDefine.js");cc._tmp.PrototypeLayerColor();delete cc._tmp.PrototypeLayerColor;
...
z:0};f.tl.vertices={x:a,y:e,z:0};f.tr.vertices={x:d,y:e,z:0};this._quadDirty=!0}};a.updateTransform=function(){if(this.dirty){var a=this._quad,c=this._parent;if(!this._visible||c&&c!=this._batchNode&&c._shouldBeHidden)a.br.vertices=a.tl.vertices=a.tr.vertices=a.bl.vertices={x:0,y:0,z:0},this._shouldBeHidden=!0;else{this._shouldBeHidden=!1;var d=this._transformToBatch=c&&c!=this._batchNode?cc.affineTransformConcat(this.getNodeToParentTransform(),c._transformToBatch):this.getNodeToParentTransform(),
e=this._rect,c=this._offsetPosition.x,f=this._offsetPosition.y,g=c+e.width,h=f+e.height,k=d.tx,m=d.ty,n=d.a,q=d.b,r=d.d,t=-d.c,d=c*n-f*t+k,e=c*q+f*r+m,u=g*n-f*t+k,f=g*q+f*r+m,s=g*n-h*t+k,g=g*q+h*r+m,k=c*n-h*t+k,c=c*q+h*r+m,h=this._vertexZ;cc.SPRITEBATCHNODE_RENDER_SUBPIXEL||(d|=0,e|=0,u|=0,f|=0,s|=0,g|=0,k|=0,c|=0);a.bl.vertices={x:d,y:e,z:h};a.br.vertices={x:u,y:f,z:h};a.tl.vertices={x:k,y:c,z:h};a.tr.vertices={x:s,y:g,z:h}}this.textureAtlas.updateQuad(a,this.atlasIndex);this.dirty=this._recursiveDirty=
!1}this._hasChildren&&this._arrayMakeObjectsPerformSelector(this._children,cc.Node._stateCallbackType.updateTransform);cc.SPRITE_DEBUG_DRAW&&(a=[cc.p(this._quad.bl.vertices.x,this._quad.bl.vertices.y),cc.p(this._quad.br.vertices.x,this._quad.br.vertices.y),cc.p(this._quad.tr.vertices.x,this._quad.tr.vertices.y),cc.p(this._quad.tl.vertices.x,this._quad.tl.vertices.y)],cc._drawingUtil.drawPoly(a,4,!0))};a.addChild=function(a,c,d){cc.assert(a,cc._LogInfos.Sprite_addChild_3);null==c&&(c=a._localZOrder);
null==d&&(d=a.tag);if(this._batchNode){if(!(a instanceof cc.Sprite)){cc.log(cc._LogInfos.Sprite_addChild);return}a.texture._webTextureObj!==this.textureAtlas.texture._webTextureObj&&cc.log(cc._LogInfos.Sprite_addChild_2);this._batchNode.appendChild(a);this._reorderChildDirty||this._setReorderChildDirtyRecursively()}cc.Node.prototype.addChild.call(this,a,c,d);this._hasChildren=!0};a.setOpacity=function(a){cc.Node.prototype.setOpacity.call(this,a);this.updateColor()};a.setColor=function(a){cc.Node.prototype.setColor.call(this,
...
cc._getCompositeOperationByBlendFunc=function(a){return a?a.src==cc.SRC_ALPHA&&a.dst==cc.ONE||a.src==cc.ONE&&a.dst==cc.ONE?"lighter":a.src==cc.ZERO&&a.dst==cc.SRC_ALPHA?"destination-in":a.src==cc.ZERO&&a.dst==cc.ONE_MINUS_SRC_ALPHA?"destination-out":"source-over":"source-over"};
...
a);this._setColorsString()},getLineHeight:function(){return this._lineHeight||this._fontClientHeight},setLineHeight:function(a){this._lineHeight=a},getString:function(){return this._string},getHorizontalAlignment:function(){return this._hAlignment},getVerticalAlignment:function(){return this._vAlignment},getDimensions:function(){return cc.size(this._dimensions)},getFontSize:function(){return this._fontSize},getFontName:function(){return this._fontName},initWithStringAndTextDefinition:null,setTextDefinition:function(a){a&&
this._updateWithTextDefinition(a,!0)},getTextDefinition:function(){return this._prepareTextDefinition(!1)},enableShadow:function(a,b,c,d){null!=a.r&&null!=a.g&&null!=a.b&&null!=a.a?this._enableShadow(a,b,c):this._enableShadowNoneColor(a,b,c,d)},_enableShadowNoneColor:function(a,b,c,d){c=c||0.5;!1===this._shadowEnabled&&(this._shadowEnabled=!0);var e=this._shadowOffset;if(e&&e.x!=a||e._y!=b)e.x=a,e.y=b;this._shadowOpacity!=c&&(this._shadowOpacity=c);this._setColorsString();this._shadowBlur!=d&&(this._shadowBlur=
d);this._setUpdateTextureDirty()},_enableShadow:function(a,b,c){this._shadowColor||(this._shadowColor=cc.color(255,255,255,128));this._shadowColor.r=a.r;this._shadowColor.g=a.g;this._shadowColor.b=a.b;this._enableShadowNoneColor(b.width||b.x||0,b.height||b.y||0,null!=a.a?a.a/255:0.5,c)},_getShadowOffsetX:function(){return this._shadowOffset.x},_setShadowOffsetX:function(a){!1===this._shadowEnabled&&(this._shadowEnabled=!0);this._shadowOffset.x!=a&&(this._shadowOffset.x=a,this._setUpdateTextureDirty())},
_getShadowOffsetY:function(){return this._shadowOffset._y},_setShadowOffsetY:function(a){!1===this._shadowEnabled&&(this._shadowEnabled=!0);this._shadowOffset._y!=a&&(this._shadowOffset._y=a,this._setUpdateTextureDirty())},_getShadowOffset:function(){return cc.p(this._shadowOffset.x,this._shadowOffset.y)},_setShadowOffset:function(a){!1===this._shadowEnabled&&(this._shadowEnabled=!0);if(this._shadowOffset.x!=a.x||this._shadowOffset.y!=a.y)this._shadowOffset.x=a.x,this._shadowOffset.y=a.y,this._setUpdateTextureDirty()},
...
g=this._strokeSize;a.setTransform(1,0,0,1,0+0.5*b,d+0.5*c);a.font!=this._fontStyleStr&&(a.font=this._fontStyleStr);a.fillStyle=this._fillColorStr;var h=c=0,k=this._strokeEnabled;k&&(a.lineWidth=2*g,a.strokeStyle=this._strokeColorStr);this._shadowEnabled&&(g=this._shadowOffset,a.shadowColor=this._shadowColorStr,a.shadowOffsetX=g.x,a.shadowOffsetY=-g.y,a.shadowBlur=this._shadowBlur);a.textBaseline=cc.LabelTTF._textBaseline[e];a.textAlign=cc.LabelTTF._textAlign[f];var m=this._contentSize.width-b,b=this.getLineHeight(),
g=(b-this._fontClientHeight)/2,c=f===cc.TEXT_ALIGNMENT_RIGHT?c+m:f===cc.TEXT_ALIGNMENT_CENTER?c+m/2:c+0;if(this._isMultiLine)for(f=this._strings.length,e===cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM?h=b-2*g+d-b*f:e===cc.VERTICAL_TEXT_ALIGNMENT_CENTER&&(h=(b-2*g)/2+(d-b*f)/2),e=0;e<f;e++){var m=this._strings[e],n=-d+(b*e+g)+h;k&&a.strokeText(m,c,n);a.fillText(m,c,n)}else e!==cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM&&(h=e===cc.VERTICAL_TEXT_ALIGNMENT_TOP?h-d:h-0.5*d),k&&a.strokeText(this._string,c,h),a.fillText(this._string,
c,h)}},_getLabelContext:function(){if(this._labelContext)return this._labelContext;if(!this._labelCanvas){var a=cc.newElement("canvas"),b=new cc.Texture2D;b.initWithElement(a);this.texture=b;this._labelCanvas=a}return this._labelContext=this._labelCanvas.getContext("2d")},_checkWarp:function(a,b,c){var d=a[b],e=this._measure(d);if(e>c&&1<d.length){for(var f=c/e*d.length|0,g=d.substr(f),h=e-this._measure(g),k,m=0,n=0;h>c&&100>n++;)f*=c/h,f|=0,g=d.substr(f),h=e-this._measure(g);for(n=0;h<c&&100>n++;)g&&
(m=(k=cc.LabelTTF._wordRex.exec(g))?k[0].length:1,k=g),f+=m,g=d.substr(f),h=e-this._measure(g);f-=m;0===f&&(f=1,k=k.substr(1));c=d.substr(0,f);cc.LabelTTF.wrapInspection&&cc.LabelTTF._symbolRex.test(k||g)&&(e=cc.LabelTTF._lastWordRex.exec(c),f-=e?e[0].length:0,k=d.substr(f),c=d.substr(0,f));cc.LabelTTF._firsrEnglish.test(k)&&(e=cc.LabelTTF._lastEnglish.exec(c))&&c!==e[0]&&(f-=e[0].length,k=d.substr(f),c=d.substr(0,f));a[b]=k||g;a.splice(b,0,c)}},_updateTTF:function(){var a=this._dimensions.width,
b,c,d=this._lineWidths;d.length=0;this._isMultiLine=!1;this._measureConfig();if(0!==a)for(this._strings=this._string.split("\n"),b=0;b<this._strings.length;b++)this._checkWarp(this._strings,b,a);else for(this._strings=this._string.split("\n"),b=0,c=this._strings.length;b<c;b++)d.push(this._measure(this._strings[b]));0<this._strings.length&&(this._isMultiLine=!0);c=b=0;this._strokeEnabled&&(b=c=2*this._strokeSize);if(this._shadowEnabled){var e=this._shadowOffset;b+=2*Math.abs(e.x);c+=2*Math.abs(e.y)}a=
0===a?this._isMultiLine?cc.size(0|Math.max.apply(Math,d)+b,0|this._fontClientHeight*this._strings.length+c):cc.size(0|this._measure(this._string)+b,0|this._fontClientHeight+c):0===this._dimensions.height?this._isMultiLine?cc.size(0|a+b,0|this.getLineHeight()*this._strings.length+c):cc.size(0|a+b,0|this.getLineHeight()+c):cc.size(0|a+b,0|this._dimensions.height+c);this.setContentSize(a);this._strokeShadowOffsetX=b;this._strokeShadowOffsetY=c;d=this._anchorPoint;this._anchorPointInPoints.x=0.5*b+(a.width-
b)*d.x;this._anchorPointInPoints.y=0.5*c+(a.height-c)*d.y},getContentSize:function(){this._needUpdateTexture&&this._updateTTF();return cc.Sprite.prototype.getContentSize.call(this)},_getWidth:function(){this._needUpdateTexture&&this._updateTTF();return cc.Sprite.prototype._getWidth.call(this)},_getHeight:function(){this._needUpdateTexture&&this._updateTTF();return cc.Sprite.prototype._getHeight.call(this)},_updateTexture:function(){var a=this._getLabelContext(),b=this._labelCanvas,c=this._contentSize;
if(0===this._string.length)return b.width=1,b.height=c.height||1,this._texture&&this._texture.handleLoadedTexture(),this.setTextureRect(cc.rect(0,0,1,c.height)),!0;a.font=this._fontStyleStr;this._updateTTF();var d=c.width,c=c.height,e=b.width==d&&b.height==c;b.width=d;b.height=c;e&&a.clearRect(0,0,d,c);this._drawTTFInCanvas(a);this._texture&&this._texture.handleLoadedTexture();this.setTextureRect(cc.rect(0,0,d,c));return!0},visit:function(a){this._string&&""!=this._string&&(this._needUpdateTexture&&
(this._needUpdateTexture=!1,this._updateTexture()),cc.Sprite.prototype.visit.call(this,a||cc._renderContext))},draw:null,_setTextureCoords:function(a){var b=this._batchNode?this.textureAtlas.texture:this._texture;if(b){var c=b.pixelsWidth,d=b.pixelsHeight,e,f=this._quad;this._rectRotated?(cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(b=(2*a.x+1)/(2*c),c=b+(2*a.height-2)/(2*c),e=(2*a.y+1)/(2*d),a=e+(2*a.width-2)/(2*d)):(b=a.x/c,c=(a.x+a.height)/c,e=a.y/d,a=(a.y+a.width)/d),this._flippedX&&(d=e,e=a,a=d),this._flippedY&&
(d=b,b=c,c=d),f.bl.texCoords.u=b,f.bl.texCoords.v=e,f.br.texCoords.u=b,f.br.texCoords.v=a,f.tl.texCoords.u=c,f.tl.texCoords.v=e,f.tr.texCoords.u=c,f.tr.texCoords.v=a):(cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(b=(2*a.x+1)/(2*c),c=b+(2*a.width-2)/(2*c),e=(2*a.y+1)/(2*d),a=e+(2*a.height-2)/(2*d)):(b=a.x/c,c=(a.x+a.width)/c,e=a.y/d,a=(a.y+a.height)/d),this._flippedX&&(d=b,b=c,c=d),this._flippedY&&(d=e,e=a,a=d),f.bl.texCoords.u=b,f.bl.texCoords.v=a,f.br.texCoords.u=c,f.br.texCoords.v=a,f.tl.texCoords.u=b,
f.tl.texCoords.v=e,f.tr.texCoords.u=c,f.tr.texCoords.v=e);this._quadDirty=!0}}});
...
this._topRight&&this._bottomRight&&this._bottomLeft&&this._centre){var a=this._contentSize,b=this._topLeft,c=this._topRight,d=this._bottomRight,e=this._bottomLeft,f=this._centre,g=this._centre.getContentSize(),h=b.getContentSize(),k=e.getContentSize(),m=a.width-h.width-c.getContentSize().width,a=a.height-h.height-d.getContentSize().height,m=m/g.width,a=a/g.height,h=g.width*m,n=g.height*a,q=k.width,k=k.height;if(cc._renderType==cc._RENDER_TYPE_WEBGL){var r=Math.round(h);h!=r&&(h=r,m=h/g.width);r=Math.round(n);
n!=r&&(n=r,a=n/g.height)}f.setScaleX(m);f.setScaleY(a);var g=this._left,r=this._right,t=this._top,u=this._bottom,s=cc.p(0,0);e.setAnchorPoint(s);d.setAnchorPoint(s);b.setAnchorPoint(s);c.setAnchorPoint(s);g.setAnchorPoint(s);r.setAnchorPoint(s);t.setAnchorPoint(s);u.setAnchorPoint(s);f.setAnchorPoint(s);e.setPosition(0,0);d.setPosition(q+h,0);b.setPosition(0,k+n);c.setPosition(q+h,k+n);g.setPosition(0,k);g.setScaleY(a);r.setPosition(q+h,k);r.setScaleY(a);u.setPosition(q,0);u.setScaleX(m);t.setPosition(q,
k+n);t.setScaleX(m);f.setPosition(q,k)}},_cacheScale9Sprite:function(){if(this._scale9Image){var a=cc.contentScaleFactor(),b=this._contentSize,c=cc.size(b.width*a,b.height*a),d=this._cacheCanvas,e=!1;if(d.width!=c.width||d.height!=c.height)d.width=c.width,d.height=c.height,this._cacheContext.translate(0,c.height),e=!0;cc.renderer._turnToCacheMode(this.__instanceId);this._scale9Image.visit();this._cacheContext.clearRect(0,0,c.width,-c.height);cc.renderer._renderingToCacheCanvas(this._cacheContext,
this.__instanceId,a,a);e&&this._cacheSprite.setTextureRect(cc.rect(0,0,b.width,b.height));this._cacheSprite.getParent()||this.addChild(this._cacheSprite,-1)}},ctor:function(a,b,c){cc.Node.prototype.ctor.call(this);this._spriteRect=cc.rect(0,0,0,0);this._capInsetsInternal=cc.rect(0,0,0,0);this._originalSize=cc.size(0,0);this._preferredSize=cc.size(0,0);this._capInsets=cc.rect(0,0,0,0);if(cc._renderType===cc._RENDER_TYPE_CANVAS){var d=this._cacheCanvas=cc.newElement("canvas");d.width=1;d.height=1;this._cacheContext=
d.getContext("2d");var e=this._cacheTexture=new cc.Texture2D;e.initWithElement(d);e.handleLoadedTexture();this._cacheSprite=new cc.Sprite(e);this._cacheSprite.setAnchorPoint(0,0);this.addChild(this._cacheSprite)}void 0!=a?a instanceof cc.SpriteFrame?this.initWithSpriteFrame(a,b):(d=cc.spriteFrameCache.getSpriteFrame(a),null!=d?this.initWithSpriteFrame(d,b):this.initWithFile(a,b,c)):this.init()},getOriginalSize:function(){return cc.size(this._originalSize)},getSprite:function(){return this._scale9Image},
...
a);for(var b=this._scale9Image.getChildren(),c=0;c<b.length;c++){var d=b[c];d&&d.setColor(a)}this._scale9Dirty=!0}},updateDisplayedColor:function(a){if(this._scale9Image){cc.Node.prototype.updateDisplayedColor.call(this,a);for(var b=this._scale9Image.getChildren(),c=0;c<b.length;c++){var d=b[c];if(d)if(cc._renderType===cc._RENDER_TYPE_CANVAS){if(cc.Node.prototype.updateDisplayedColor.call(d,a),255!==a.r||255!==a.g||255!==a.b)d._changeTextureColor(),d._setNodeDirtyForCache()}else d.updateDisplayedColor(a)}this._scale9Dirty=
...
setInsetRight:function(a){this._insetRight=a;this._updateCapInset()},getInsetBottom:function(){return this._insetBottom},setInsetBottom:function(a){this._insetBottom=a;this._updateCapInset()},setContentSize:function(a,b){cc.Node.prototype.setContentSize.call(this,a,b);this._positionsAreDirty=!0},_setWidth:function(a){cc.Node.prototype._setWidth.call(this,a);this._positionsAreDirty=!0},_setHeight:function(a){cc.Node.prototype._setHeight.call(this,a);this._positionsAreDirty=!0},visit:function(a){this._visible&&
(this._positionsAreDirty&&(this._updatePositions(),this._positionsAreDirty=!1,this._scale9Dirty=!0),cc._renderType===cc._RENDER_TYPE_CANVAS&&(this._scale9Dirty=!1,this._cacheScale9Sprite()),cc.Node.prototype.visit.call(this,a))},_transformForRenderer:function(){cc._renderType===cc._RENDER_TYPE_CANVAS&&(this._cacheScale9Sprite(),this.transform());cc.Node.prototype._transformForRenderer.call(this)},init:function(){return this.initWithBatchNode(null,cc.rect(0,0,0,0),!1,cc.rect(0,0,0,0))},initWithBatchNode:function(a,
b,c,d){void 0===d&&(d=c,c=!1);a&&this.updateWithBatchNode(a,b,c,d);this.setCascadeColorEnabled(!0);this.setCascadeOpacityEnabled(!0);this.setAnchorPoint(0.5,0.5);return this._positionsAreDirty=!0},initWithFile:function(a,b,c){a instanceof cc.Rect?(c=a=b,b=cc.rect(0,0,0,0)):(b=b||cc.rect(0,0,0,0),c=c||cc.rect(0,0,0,0));if(!a)throw"cc.Scale9Sprite.initWithFile(): file should be non-null";var d=cc.textureCache.getTextureForKey(a);d||(d=cc.textureCache.addImage(a));var e=d.isLoaded();(this._textureLoaded=
e)||d.addEventListener("load",function(a){var b=this._preferredSize,b=cc.size(b.width,b.height);a=a.getContentSize();this.updateWithBatchNode(this._scale9Image,cc.rect(0,0,a.width,a.height),!1,this._capInsets);this.setPreferredSize(b);this._positionsAreDirty=!0;this.dispatchEvent("load")},this);return this.initWithBatchNode(new cc.SpriteBatchNode(a,9),b,!1,c)},initWithSpriteFrame:function(a,b){if(!a||!a.getTexture())throw"cc.Scale9Sprite.initWithSpriteFrame(): spriteFrame should be non-null and its texture should be non-null";
b=b||cc.rect(0,0,0,0);var c=a.textureLoaded();(this._textureLoaded=c)||a.addEventListener("load",function(a){var b=this._preferredSize,b=cc.size(b.width,b.height);this.updateWithBatchNode(this._scale9Image,a.getRect(),cc._renderType==cc._RENDER_TYPE_WEBGL&&a.isRotated(),this._capInsets);this.setPreferredSize(b);this._positionsAreDirty=!0;this.dispatchEvent("load")},this);c=new cc.SpriteBatchNode(a.getTexture(),9);return this.initWithBatchNode(c,a.getRect(),cc._renderType==cc._RENDER_TYPE_WEBGL&&a.isRotated(),
b)},initWithSpriteFrameName:function(a,b){if(!a)throw"cc.Scale9Sprite.initWithSpriteFrameName(): spriteFrameName should be non-null";b=b||cc.rect(0,0,0,0);var c=cc.spriteFrameCache.getSpriteFrame(a);return null==c?(cc.log("cc.Scale9Sprite.initWithSpriteFrameName(): can't find the sprite frame by spriteFrameName"),!1):this.initWithSpriteFrame(c,b)},resizableSpriteWithCapInsets:function(a){var b=new cc.Scale9Sprite;return b&&b.initWithBatchNode(this._scale9Image,this._spriteRect,!1,a)?b:null},setOpacityModifyRGB:function(a){if(this._scale9Image){this._opacityModifyRGB=
a;var b=this._scale9Image.getChildren();if(b)for(var c=0,d=b.length;c<d;c++)b[c].setOpacityModifyRGB(a)}},isOpacityModifyRGB:function(){return this._opacityModifyRGB},updateWithBatchNode:function(a,b,c,d){var e=this.getOpacity(),f=this.getColor();b=cc.rect(b.x,b.y,b.width,b.height);this.removeAllChildren(!0);this._scale9Image!=a&&(this._scale9Image=a);if(!this._scale9Image)return!1;a=a.getTexture();var g=a.isLoaded();this._textureLoaded=g;if(!g)return a.addEventListener("load",function(a){this._positionsAreDirty=
!0;this.dispatchEvent("load")},this),!0;a=this._scale9Image;a.removeAllChildren(!0);g=this._capInsets;g.x=d.x;g.y=d.y;g.width=d.width;g.height=d.height;this._spriteFrameRotated=c;g=a.getTexture();cc._rectEqualToZero(b)&&(b=g.getContentSize(),b=cc.rect(0,0,b.width,b.height));var h=this._spriteRect=b;h.x=b.x;h.y=b.y;h.width=b.width;h.height=b.height;this._originalSize.width=b.width;this._originalSize.height=b.height;h=this._preferredSize;0===h.width&&0===h.height&&(h.width=b.width,h.height=b.height);
h=this._capInsetsInternal;d&&(h.x=d.x,h.y=d.y,h.width=d.width,h.height=d.height);var k=b.width;d=b.height;cc._rectEqualToZero(h)&&(h.x=k/3,h.y=d/3,h.width=k/3,h.height=d/3);var m=h.x,n=h.width,q=k-(m+n),r=h.y,t=h.height,u=d-(r+t),s=0,v=0;d=cc.rect(s+0.5|0,v+0.5|0,m+0.5|0,r+0.5|0);var s=s+m,h=cc.rect(s+0.5|0,v+0.5|0,n+0.5|0,r+0.5|0),k=cc.rect(s+n+0.5|0,v+0.5|0,q+0.5|0,r+0.5|0),s=0,v=0+r,w=cc.rect(s+0.5|0,v+0.5|0,m+0.5|0,t+0.5|0),s=s+m,x=cc.rect(s+0.5|0,v+0.5|0,n+0.5|0,t+0.5|0),s=s+n,y=cc.rect(s+0.5|
0,v+0.5|0,q+0.5|0,t+0.5|0),s=0,v=0+r+t,r=cc.rect(s+0.5|0,v+0.5|0,m+0.5|0,u+0.5|0),s=s+m,m=cc.rect(s+0.5|0,v+0.5|0,n+0.5|0,u+0.5|0),s=s+n,n=cc.rect(s+0.5|0,v+0.5|0,q+0.5|0,u+0.5|0),q=cc.affineTransformMakeIdentity();if(c){c=x;var u=n,s=r,v=k,t=d,z=y,A=w,B=m,C=h,q=cc.affineTransformTranslate(q,b.height+b.x,b.y),q=cc.affineTransformRotate(q,1.57079633),x=cc.rectApplyAffineTransform(x,q),n=cc.rectApplyAffineTransform(n,q),r=cc.rectApplyAffineTransform(r,q),k=cc.rectApplyAffineTransform(k,q);d=cc.rectApplyAffineTransform(d,
q);y=cc.rectApplyAffineTransform(y,q);w=cc.rectApplyAffineTransform(w,q);m=cc.rectApplyAffineTransform(m,q);h=cc.rectApplyAffineTransform(h,q);c.x=x.x;c.y=x.y;u.x=n.x;u.y=n.y;s.x=r.x;s.y=r.y;v.x=k.x;v.y=k.y;t.x=d.x;t.y=d.y;z.x=y.x;z.y=y.y;A.x=w.x;A.y=w.y;B.x=m.x;B.y=m.y;C.x=h.x;C.y=h.y;this._centre=new cc.Sprite;this._centre.initWithTexture(g,c,!0);a.addChild(this._centre,0,cc.Scale9Sprite.POSITIONS_CENTRE);this._top=new cc.Sprite;this._top.initWithTexture(g,C,!0);a.addChild(this._top,1,cc.Scale9Sprite.POSITIONS_TOP);
this._bottom=new cc.Sprite;this._bottom.initWithTexture(g,B,!0);a.addChild(this._bottom,1,cc.Scale9Sprite.POSITIONS_BOTTOM);this._left=new cc.Sprite;this._left.initWithTexture(g,A,!0);a.addChild(this._left,1,cc.Scale9Sprite.POSITIONS_LEFT);this._right=new cc.Sprite;this._right.initWithTexture(g,z,!0);a.addChild(this._right,1,cc.Scale9Sprite.POSITIONS_RIGHT);this._topLeft=new cc.Sprite;this._topLeft.initWithTexture(g,t,!0);a.addChild(this._topLeft,2,cc.Scale9Sprite.POSITIONS_TOPLEFT);this._topRight=
new cc.Sprite;this._topRight.initWithTexture(g,v,!0);a.addChild(this._topRight,2,cc.Scale9Sprite.POSITIONS_TOPRIGHT);this._bottomLeft=new cc.Sprite;this._bottomLeft.initWithTexture(g,s,!0);a.addChild(this._bottomLeft,2,cc.Scale9Sprite.POSITIONS_BOTTOMLEFT);this._bottomRight=new cc.Sprite;this._bottomRight.initWithTexture(g,u,!0)}else q=cc.affineTransformTranslate(q,b.x,b.y),cc._rectApplyAffineTransformIn(x,q),cc._rectApplyAffineTransformIn(n,q),cc._rectApplyAffineTransformIn(r,q),cc._rectApplyAffineTransformIn(k,
q),cc._rectApplyAffineTransformIn(d,q),cc._rectApplyAffineTransformIn(y,q),cc._rectApplyAffineTransformIn(w,q),cc._rectApplyAffineTransformIn(m,q),cc._rectApplyAffineTransformIn(h,q),this._centre=new cc.Sprite,this._centre.initWithTexture(g,x),a.addChild(this._centre,0,cc.Scale9Sprite.POSITIONS_CENTRE),this._top=new cc.Sprite,this._top.initWithTexture(g,h),a.addChild(this._top,1,cc.Scale9Sprite.POSITIONS_TOP),this._bottom=new cc.Sprite,this._bottom.initWithTexture(g,m),a.addChild(this._bottom,1,cc.Scale9Sprite.POSITIONS_BOTTOM),
this._left=new cc.Sprite,this._left.initWithTexture(g,w),a.addChild(this._left,1,cc.Scale9Sprite.POSITIONS_LEFT),this._right=new cc.Sprite,this._right.initWithTexture(g,y),a.addChild(this._right,1,cc.Scale9Sprite.POSITIONS_RIGHT),this._topLeft=new cc.Sprite,this._topLeft.initWithTexture(g,d),a.addChild(this._topLeft,2,cc.Scale9Sprite.POSITIONS_TOPLEFT),this._topRight=new cc.Sprite,this._topRight.initWithTexture(g,k),a.addChild(this._topRight,2,cc.Scale9Sprite.POSITIONS_TOPRIGHT),this._bottomLeft=
new cc.Sprite,this._bottomLeft.initWithTexture(g,r),a.addChild(this._bottomLeft,2,cc.Scale9Sprite.POSITIONS_BOTTOMLEFT),this._bottomRight=new cc.Sprite,this._bottomRight.initWithTexture(g,n);a.addChild(this._bottomRight,2,cc.Scale9Sprite.POSITIONS_BOTTOMRIGHT);this.setContentSize(b.width,b.height);cc._renderType===cc._RENDER_TYPE_WEBGL&&this.addChild(a);this._spritesGenerated&&(this.setOpacity(e),this.setColor(f));return this._spritesGenerated=!0},setSpriteFrame:function(a){var b=new cc.SpriteBatchNode(a.getTexture(),
9),c=a.textureLoaded();(this._textureLoaded=c)||a.addEventListener("load",function(a){var b=this._preferredSize,b=cc.size(b.width,b.height);this.updateWithBatchNode(this._scale9Image,a.getRect(),cc._renderType==cc._RENDER_TYPE_WEBGL&&a.isRotated(),this._capInsets);this.setPreferredSize(b);this._positionsAreDirty=!0;this.dispatchEvent("load")},this);this.updateWithBatchNode(b,a.getRect(),cc._renderType==cc._RENDER_TYPE_WEBGL&&a.isRotated(),cc.rect(0,0,0,0));this._insetBottom=this._insetRight=this._insetTop=
this._insetLeft=0}});_p=cc.Scale9Sprite.prototype;cc.EventHelper.prototype.apply(_p);cc.defineGetterSetter(_p,"preferredSize",_p.getPreferredSize,_p.setPreferredSize);cc.defineGetterSetter(_p,"capInsets",_p.getCapInsets,_p.setCapInsets);cc.defineGetterSetter(_p,"insetLeft",_p.getInsetLeft,_p.setInsetLeft);cc.defineGetterSetter(_p,"insetTop",_p.getInsetTop,_p.setInsetTop);cc.defineGetterSetter(_p,"insetRight",_p.getInsetRight,_p.setInsetRight);
...
cc.Scale9Sprite.POSITIONS_TOPRIGHT=5;cc.Scale9Sprite.POSITIONS_TOPLEFT=6;cc.Scale9Sprite.POSITIONS_BOTTOMRIGHT=7;var res={wall_png:"res/wall.png",items_plist:"res/items.plist",items_png:"res/items.png"},g_resources=[],i;for(i in res)g_resources.push(res[i]);var marginX=130,marginY=130,width=1200,height=800,CFG={width:width,height:height,marginX:marginX,marginY:marginY,tileRow:8,tileCol:14,groundW:width-2*marginX,groundH:height-2*marginY,leftBorder:marginX,rightBorder:width-marginX,downBorder:marginY,upBorder:height-marginY,inScaleX:0.78,inScaleY:0.68,outScaleX:1.3,outScaleY:1.5,tileBreakTime:0.5,Wall:{tex:res.wall_png,rect:cc.rect(0,0,598,396),capInset:cc.rect(0,0,598,396)},Hero:{scale:0.7,speed:5,hp:100},Enemy:{chaseSpeed:1.5,restSpeed:0.5,runSpeed:2,
warnDis:300,damage:10,courageTime:7,chaseFr:"fantome_chase.png",runFr:"fantome_run.png",restFr:"fantome_rest.png"},itemInterval:350,itemDuration:5,bulletSpeed:8,bulletZ:8,flowerDamage:1,bulletDamage:1,pacmanDamage:1,bladeDamage:1,frameTag:123,home1X:280,home1Y:200,home2X:950,home2Y:350,objZ:7,itemsZ:4};function easyRandom(a,b){return Math.round(a+Math.random()*b-b/2)};var Tile=cc.Sprite.extend({ctor:function(a,b,c,d){this._super(a,b);this.scaleX=c/b.width;this.scaleY=d/b.height}}),TiledLayer=cc.Layer.extend({_row:0,_col:0,_tw:0,_th:0,_batchNode:null,_frame:null,_breakAnime:null,ctor:function(a,b,c,d){var e,f,g,h,k;cc.p(0,0);this._super();this._row=d;this._col=c;a=this._tw=Math.floor(a/this._col);k=this._th=Math.floor(b/this._row);this._frame=cc.spriteFrameCache.getSpriteFrame("tile1.png");g=this._frame.getTexture();h=this._frame.getRect();this._batchNode=new cc.SpriteBatchNode(g,
d*c);for(b=0;b<d;++b)for(e=0;e<c;++e)f=new Tile(g,h,a,k),f.x=e*a+a/2,f.y=b*k+k/2,this._batchNode.addChild(f);this.addChild(this._batchNode);c=[];for(b=1;6>b;b++)c.push(cc.spriteFrameCache.getSpriteFrame("tile"+b+".png"));this._breakAnime=new cc.Animation(c,0.1)},breakDown:function(){var a=this._batchNode.children,b,c,d;b=0;for(c=a.length;b<c;++b)d=a[b],d.runAction(cc.animate(this._breakAnime))}});var WallLayer=cc.Sprite.extend({_wall:null,ctor:function(a,b){this._super(CFG.Wall.tex);this.scaleX=a/this.width;this.scaleY=b/this.height;this.x=a/2;this.y=b/2}});var Hero=cc.Sprite.extend({upAnime:null,downAnime:null,leftAnime:null,rightAnime:null,fallAnime:null,dieAnime:null,standUp:null,standDown:null,standLeft:null,standRight:null,preFallFr:null,fallingFr:null,landedFr:null,collisionObjs:null,speed:CFG.Hero.speed,hp:CFG.Hero.hp,unhurtable:!1,isFalling:!1,faceLeft:!1,faceRight:!1,faceUp:!1,faceDown:!1,walking:!1,w:0,h:0,item:null,ctor:function(){var a,b,c=["downAnime","leftAnime","rightAnime","upAnime"],d,e,f;this._super("#hero1.png");for(b=0;4>b;++b){d=
c[b];f=[];for(a=1;3>a;++a)e=cc.spriteFrameCache.getSpriteFrame("hero"+(3*b+a+1)+".png"),f.push(e);a=new cc.Animation(f,0.2);this[d]=cc.animate(a).repeatForever()}this.standDown=cc.spriteFrameCache.getSpriteFrame("hero1.png");this.standLeft=cc.spriteFrameCache.getSpriteFrame("hero4.png");this.standRight=cc.spriteFrameCache.getSpriteFrame("hero7.png");this.standUp=cc.spriteFrameCache.getSpriteFrame("hero10.png");this.preFallFr=cc.spriteFrameCache.getSpriteFrame("hero13.png");this.fallingFr=cc.spriteFrameCache.getSpriteFrame("hero14.png");
this.landedFr=cc.spriteFrameCache.getSpriteFrame("hero15.png");f=[];f.push(cc.spriteFrameCache.getSpriteFrame("hero16.png"));f.push(cc.spriteFrameCache.getSpriteFrame("hero17.png"));f.push(cc.spriteFrameCache.getSpriteFrame("hero18.png"));a=new cc.Animation(f,0.2);this.dieAnime=cc.animate(a).repeatForever();this.stand();this.collisionObjs=[];this.scale=CFG.Hero.scale;this.w=this.width*CFG.Hero.scale*0.5;this.h=this.height*CFG.Hero.scale*0.8},onEnter:function(){this._super();cc.eventManager.addListener(HeroKeyboardManager,
this)},addCollisionObj:function(a){this.collisionObjs.push(a)},removeCollisionObj:function(a){a=this.collisionObjs.indexOf(a);-1!=a&&this.collisionObjs.splice(a,1)},stand:function(){this.stopAllActions();this.walking=!1;this.faceUp?this.setSpriteFrame(this.standUp):this.faceDown?this.setSpriteFrame(this.standDown):this.faceLeft?this.setSpriteFrame(this.standLeft):this.faceRight&&this.setSpriteFrame(this.standRight)},fall:function(){this.walking=!1;this.isFalling=!0;this.stopAllActions();this.setSpriteFrame(this.preFallFr)},
falling:function(){this.isFalling=!0;this.stopAllActions();this.setSpriteFrame(this.fallingFr)},landed:function(){this.isFalling=!0;this.stopAllActions();this.setSpriteFrame(this.landedFr);this.scheduleOnce(this.fallOver,0.3)},fallOver:function(){this.isFalling=!1;this.faceDown=!0;this.stand()},hasWeapon:function(){return this.item&&this.item.isWeapon?!0:!1},shoot:function(){if(!this.dead&&this.item){var a=this.faceRight?1:this.faceLeft?-1:0,b=this.faceUp?1:this.faceDown?-1:0;cc.log("Shoot");this.item.fire(this.x,
this.y,a,b);this.item.release();this.item=null}},die:function(){this.dead||(this.dead=!0,this.stopAllActions(),this.runAction(this.dieAnime))},hurt:function(a){this.unhurtable||this.dead||(0>=this.hp?this.die():(this.hp-=a,cc.log("HP: "+this.hp),this.unhurtable=!0,this.scheduleOnce(this.turnNormal,1)))},turnNormal:function(){this.unhurtable=!1},getItem:function(a){a.removeFromParent(!0);a.isWeapon?(a.retain(),this.item=a):a.fire()},update:function(){if(!this.dead){var a=this.x,b=this.y,c,d,e,f,g;
this.walking&&(this.faceRight&&a<=CFG.rightBorder?a+=this.speed:this.faceLeft&&a>=CFG.leftBorder?a-=this.speed:this.faceUp&&b<=CFG.upBorder?b+=this.speed:this.faceDown&&b>=CFG.downBorder&&(b-=this.speed));f=cc.rect(a-this.w/2,b-this.h/2,this.w,this.h);c=0;for(d=this.collisionObjs.length;c<d;c++)if(e=this.collisionObjs[c],g=e.getCollisionRect(),cc.rectIntersectsRect(f,g)){e.collision=!0;return}this.x=a;this.y=b}}}),_p=Hero.prototype;var HeroKeyboardManager=cc.EventListener.create({event:cc.EventListener.KEYBOARD,onKeyPressed:function(a,b){var c=b.getCurrentTarget();c.isFalling||c.dead||(39!=a||c.walking&&c.faceRight?37!=a||c.walking&&c.faceLeft?38!=a||c.walking&&c.faceUp?40!=a||c.walking&&c.faceDown?32==a&&c.shoot():(c.faceUp=!1,c.faceDown=!0,c.faceLeft=!1,c.faceRight=!1,c.walking=!0,c.stopAllActions(),c.runAction(c.downAnime)):(c.faceUp=!0,c.faceDown=!1,c.faceLeft=!1,c.faceRight=!1,c.walking=!0,c.stopAllActions(),c.runAction(c.upAnime)):
(c.faceUp=!1,c.faceDown=!1,c.faceLeft=!0,c.faceRight=!1,c.walking=!0,c.stopAllActions(),c.runAction(c.leftAnime)):(c.faceUp=!1,c.faceDown=!1,c.faceLeft=!1,c.faceRight=!0,c.walking=!0,c.stopAllActions(),c.runAction(c.rightAnime)))},onKeyReleased:function(a,b){var c=b.getCurrentTarget();c.isFalling||c.dead||(c.faceRight&&39==a?c.stand():c.faceLeft&&37==a?c.stand():c.faceUp&&38==a?c.stand():c.faceDown&&40==a&&c.stand())}});var RoomLayer=cc.Layer.extend({_wallLayer:null,_tiledLayer:null,_itemLayer:null,crystalLayer:null,hero:null,nextItemCount:CFG.itemInterval,ctor:function(a,b,c){this._super();this.hero=a;this._tiledLayer=new TiledLayer(CFG.width-2*CFG.marginX,CFG.height-2*CFG.marginY,CFG.tileCol,CFG.tileRow);this._tiledLayer.x=CFG.marginX;this._tiledLayer.y=CFG.marginY;this.addChild(this._tiledLayer);this._wallLayer=new WallLayer(cc.winSize.width,cc.winSize.height);this.addChild(this._wallLayer);this._itemLayer=new ItemLayer(b,
c);this._itemLayer.x=CFG.marginX;this._itemLayer.y=CFG.marginY;this._itemLayer.width=CFG.groundW;this._itemLayer.height=CFG.groundH;this.addChild(this._itemLayer,CFG.itemsZ)},update:function(a){var b=0,c=this.hero.getPosition(),d,e=this._itemLayer.children,f,g,h,k=this.children;0==this.nextItemCount&&(this._itemLayer.addItem(),this.nextItemCount=easyRandom(CFG.itemInterval,CFG.itemInterval));this.nextItemCount--;f=0;for(g=e.length;f<g;++f)if(h=e[f],h.isItem&&(b=c.x-(h._position.x+CFG.marginX),d=c.y-
(h._position.y+CFG.marginY),b=Math.round(Math.sqrt(b*b+d*d)),b<h.width)){this.hero.getItem(h);break}f=0;for(g=k.length;f<g;++f)c=k[f],c.update&&c.update(a)},cleanUp:function(){var a,b=this.children;for(a=b.length-1;0<=a;--a)child=b[a],child==this._wallLayer||child.removeFromParent(!0)}});var Enemy=cc.Sprite.extend({target:null,dieAnime:null,runAnime:null,chaseAnime:null,chaseFr:null,runFr:null,restFr:null,dirInDegree:0,direction:0,speed:CFG.Enemy.chaseSpeed,_currVec:cc.p(),_count:0,damage:CFG.Enemy.damage,chasing:!1,ranning:!1,couraged:!1,courageScheduled:!1,disabled:!1,ctor:function(a){this.chaseFr=cc.spriteFrameCache.getSpriteFrame(CFG.Enemy.chaseFr);this.runFr=cc.spriteFrameCache.getSpriteFrame(CFG.Enemy.runFr);this.restFr=cc.spriteFrameCache.getSpriteFrame(CFG.Enemy.restFr);this._super(this.restFr);
this.target=a;this.speed+=1*Math.random()-0.5;this.dieAnime=cc.fadeOut(0.5)},update:function(a){if(!this.disabled){a=this.x;var b=this.y,c,d;15<=this._count&&(this.strategy(),this._count=0);this._count++;c=this.speed*Math.cos(this.direction);d=this.speed*Math.sin(this.direction);a+=c;b+=d;a<CFG.width&&-1<a&&(this.x=a,0<c&&!this._flippedX?this.flippedX=!0:0>c&&this._flippedX&&(this.flippedX=!1));b<CFG.height&&-1<b&&(this.y=b)}},strategy:function(){var a=0,b=this.target.getPosition(),c=CFG.Enemy.warnDis,
a=this._currVec.x=b.x-(this._position.x+this.parent._position.x),b=this._currVec.y=b.y-(this._position.y+this.parent._position.y),a=Math.round(Math.sqrt(a*a+b*b));a<this.width/2&&this.target.hurt(this.damage);if(!this.target.dead&&!this.couraged&&this.target.hasWeapon()&&a<c)this.runAway();else if(!this.target.dead&&a<c)this.goAfter();else if(this.direction=Math.random()*Math.PI*2,this.dirInDegree=180*this.direction/Math.PI,this.chasing||this.ranning)this.ranning=this.chasing=!1,this.setSpriteFrame(this.restFr)},
goAfter:function(){this.direction=cc.pToAngle(this._currVec);0>this.direction&&(this.direction+=2*Math.PI);this.dirInDegree=180*this.direction/Math.PI;this.chasing||(this.chasing=!0,this.ranning=!1,this.stopAllActions(),this.setSpriteFrame(this.chaseFr),this.chaseAnime&&this.runAction(this.chaseAnime))},runAway:function(){this.direction=cc.pToAngle(cc.p(-this._currVec.x,-this._currVec.y));0>this.direction&&(this.direction+=2*Math.PI);this.dirInDegree=180*this.direction/Math.PI;this.ranning||(this.chasing=
!1,this.ranning=!0,this.stopAllActions(),this.setSpriteFrame(this.runFr),this.runAnime&&this.runAction(this.runAnime),this.courageScheduled||(this.scheduleOnce(this.getCouraged,CFG.Enemy.courageTime+Math.floor(Math.random()*CFG.Enemy.courageTime)),this.courageScheduled=!0))},getCouraged:function(){this.couraged=!0;cc.log("Couraged")},hurt:function(){this.setSpriteFrame(this.runFr);this.runAction(cc.sequence(this.dieAnime,cc.callFunc(this.removeFromParent,this)))}});EnemyLayer=cc.Layer.extend({target:null,ctor:function(a){this._super();this.target=a},addEnemy:function(a){a=new a(this.target);this.addChild(a);a.x=a.width/2+Math.round(Math.random()*this.width-a.width);a.y=a.height/2+Math.round(Math.random()*this.height-a.height);a.goAfter()},update:function(a){var b=this.children,c,d;c=0;for(d=b.length;c<d;++c)b[c].update(a)}});var Bullet=cc.Sprite.extend({speedX:0,speedY:0,dead:!1,damage:0,setAnimation:function(a,b){var c,d,e,f=[];c=0;for(d=a.length;c<d;++c)e=cc.spriteFrameCache.getSpriteFrame(a[c]),f.push(e);c=new cc.Animation(f,b);this.runAction(cc.animate(c).repeatForever())},update:function(){if(!this.dead){var a=this.x,b=this.y,c=GameScene.instance.enemies,d,e,f,g,h,a=a+this.speedX,b=b+this.speedY;d=0;for(e=c.length;d<e;++d)if(g=c[d],f=g.getPosition(),h=f.x-a,f=f.y-b,h=Math.round(Math.sqrt(h*h+f*f)),h<this.width){this.dead=
!0;this.scheduleOnce(this.removeFromParent,0);g.hurt(this.damage);return}a>CFG.width||0>a||b>CFG.height||0>b?(this.dead=!0,this.scheduleOnce(this.removeFromParent,0)):(this.x=a,this.y=b)}}}),Item=cc.Sprite.extend({isItem:!0,isWeapon:!1,onEnter:function(){this._super();this.scheduleOnce(this.removeFromParent,easyRandom(CFG.itemDuration,CFG.itemDuration))},setFrame:function(a){a=new cc.Sprite(a);a.x=this.width/2;a.y=this.height/2;this.addChild(a,-1,CFG.frameTag)},fire:function(){}}),Armor=Item.extend({ctor:function(){this._super("#armor.png");
this.isWeapon=!0;this.setFrame("#frame.png")},fire:function(a,b,c,d){var e=new Bullet("#bullet.png");e.x=a;e.y=b;e.speedX=CFG.bulletSpeed*c;e.speedY=CFG.bulletSpeed*d;e.damage=CFG.bulletDamage;GameScene.instance.addChild(e,CFG.bulletZ)}}),Shell=Item.extend({ctor:function(){this._super("#shell.png");this.setFrame("#frame.png")},fire:function(){var a=GameScene.instance._hero;this.setFrame.call(a,"#hero_frame.png");a.unhurtable=!0;a.scheduleOnce(function(){a.unhurtable=!1;a.getChildByTag(CFG.frameTag).removeFromParent(!0)},
5)}}),Timer=Item.extend({ctor:function(){this._super("#timer.png");this.setFrame("#frame.png")},fire:function(){var a=GameScene.instance.enemies;i=0;for(l=a.length;i<l;++i)a[i].disabled=!0;GameScene.instance._hero.scheduleOnce(function(){var a=GameScene.instance.enemies;i=0;for(l=a.length;i<l;++i)a[i].disabled=!1},5)}}),Flower=Item.extend({ctor:function(){this._super("#flower.png");this.isWeapon=!0;this.setFrame("#frame.png")},fire:function(a,b,c,d){var e=new Bullet("#fire1.png");e.x=a;e.y=b;e.speedX=
CFG.bulletSpeed*c;e.speedY=CFG.bulletSpeed*d;e.damage=CFG.flowerDamage;e.setAnimation(["fire1.png","fire2.png","fire3.png","fire4.png"],0.1);GameScene.instance.addChild(e,CFG.bulletZ)}}),Pacman=Item.extend({ctor:function(){this._super("#packman.png");this.isWeapon=!0;this.setFrame("#frame.png")},fire:function(a,b,c,d){var e=new Bullet("#pacman1.png");e.x=a;e.y=b;e.speedX=c;e.speedY=d;0>e.speedX?e.flippedX=!0:0<e.speedY?e.rotation=270:0>e.speedY&&(e.rotation=90);e.damage=CFG.pacmanDamage;e.setAnimation(["pacman1.png",
"pacman2.png"],0.3);GameScene.instance.addChild(e,CFG.bulletZ)}}),MasterBlade=Item.extend({ctor:function(){this._super("#master_blade.png");this.isWeapon=!0;this.setFrame("#frame.png")},fire:function(a,b,c,d){var e=new Bullet("#blade_wave.png");e.x=a;e.y=b;e.speedX=CFG.bulletSpeed*c;e.speedY=CFG.bulletSpeed*d;e.damage=CFG.bladeDamage;GameScene.instance.addChild(e,CFG.bulletZ)}}),Crystal=cc.Sprite.extend({isItem:!0,fire:function(a,b,c,d){GameScene.instance.getCrystal(this)}}),Block=cc.Sprite.extend({collision:!1,
onEnter:function(){this._super();GameScene.instance._hero.addCollisionObj(this)},onExit:function(){this._super();GameScene.instance._hero.removeCollisionObj(this)},getCollisionRect:function(){var a=this._contentSize.width,b=this._contentSize.height;return cc.rect(this._position.x+this.parent._position.x-a/2,this._position.y+this.parent._position.y-b/2,a,b)}}),MagicWall=Block.extend({mashroom:null,onEnter:function(){this._super();this.mashroom=new Crystal("#mashroom.png");this.mashroom.x=this.x-CFG.marginX;
this.mashroom.y=this.y-CFG.marginY+5;GameScene.instance.addCrystal(this.mashroom,CFG.objZ-1);this.mashroom.visible=!1},update:function(){var a,b,c;this.collision&&(a=GameScene.instance._hero,c=this.y-a.y,b=this.x-a.x,0<c&&c<=(this.width+a.width+4)/2&&20>Math.abs(b)&&(this.mashroom.visible=!0,this.mashroom.runAction(cc.moveTo(0.5,this.mashroom.x,this.mashroom.y+(this.mashroom.height+this.height)/2-5)),this.update=null),this.collision=!1)}}),TankHome=Crystal.extend({walls:null,onEnter:function(){var a,
b=this.x+CFG.marginX,c=this.y+CFG.marginY;this._super();this.walls=[];a=new Block("#sand_wall.png");a.x=b-77;a.y=c;GameScene.instance._enemyLayer.addChild(a);a.hurt=this.wallHurt;this.walls.push(a);a=new Block("#sand_wall.png");a.x=b-77;a.y=c+62;GameScene.instance._enemyLayer.addChild(a);a.hurt=this.wallHurt;this.walls.push(a);a=new Block("#sand_wall.png");a.x=b-77;a.y=c-62;GameScene.instance._enemyLayer.addChild(a);a.hurt=this.wallHurt;this.walls.push(a);a=new Block("#sand_wall.png");a.x=b+77;a.y=
c;GameScene.instance._enemyLayer.addChild(a);a.hurt=this.wallHurt;this.walls.push(a);a=new Block("#sand_wall.png");a.x=b+77;a.y=c+62;GameScene.instance._enemyLayer.addChild(a);a.hurt=this.wallHurt;this.walls.push(a);a=new Block("#sand_wall.png");a.x=b+77;a.y=c-62;GameScene.instance._enemyLayer.addChild(a);a.hurt=this.wallHurt;this.walls.push(a);a=new Block("#sand_wall.png");a.x=b;a.y=c+62;GameScene.instance._enemyLayer.addChild(a);a.hurt=this.wallHurt;this.walls.push(a);a=new Block("#sand_wall.png");
a.x=b;a.y=c-62;GameScene.instance._enemyLayer.addChild(a);a.hurt=this.wallHurt;this.walls.push(a)},onExit:function(){var a,b;a=0;for(b=this.walls.length;a<b;++a)GameScene.instance.removeObject(this.walls[a]);this.walls=[];this._super()},wallHurt:function(a){this.removeFromParent(!0)}}),PacmanEnemy=null,HeartBase=null,ContraWall=null,ContraArmor=null;var ItemLayer=cc.Layer.extend({itemTypes:null,probs:null,ctor:function(a,b){this._super();this.itemTypes=a;this.probs=b},addItem:function(){var a,b,c,d=Math.random();b=0;for(c=this.itemTypes.length;b<c;++b)if(d<this.probs[b]){a=this.itemTypes[b];break}a&&(a=new a,this.addChild(a),a.x=a.width/2+Math.round(Math.random()*this.width-a.width),a.y=a.height/2+Math.round(Math.random()*this.height-a.height))}});var Levels=[{itemTypes:[],itemProbs:[],enemyCount:0,objs:[{tex:"#pac_enemy.png",type:Crystal,pos:[200,450]}]},{itemTypes:[Flower,Timer],itemProbs:[0.8,0.9],enemyCount:3,objs:[{tex:"#magic_wall.png",type:MagicWall,pos:[600,250]},{tex:"#magic_wall.png",type:MagicWall,pos:[200,450]}]},{itemTypes:[Armor,Shell,Timer],itemProbs:[0.8,0.9,1],enemyCount:5,objs:[{tex:"#home.png",type:TankHome,pos:[130,50]},{tex:"#home.png",type:TankHome,pos:[800,200]}]},{itemTypes:[Pacman,Shell,Timer],itemProbs:[0.65,0.75,
0.9],enemyCount:5,objs:[{tex:"#pac_enemy.png",type:PacmanEnemy,pos:[50,50]},{tex:"#pac_enemy.png",type:PacmanEnemy,pos:[50,418]},{tex:"#pac_enemy.png",type:PacmanEnemy,pos:[818,50]},{tex:"#pac_enemy.png",type:PacmanEnemy,pos:[818,418]}]},{itemTypes:[MasterBlade,Shell,Timer],itemProbs:[0.7,0.8,0.9],enemyCount:5,objs:[{tex:"#static_wall.png",type:HeartBase,pos:[220,320]},{tex:"#static_wall.png",type:HeartBase,pos:[450,550]},{tex:"#static_wall.png",type:HeartBase,pos:[220,320]}]},{itemTypes:[Armor,Shell,
Timer],itemProbs:[0.7,0.8,0.9],enemyCount:5,objs:[{tex:"#contra_wall.png",type:ContraWall,pos:[900,400]},{tex:"#armor_block.png",type:ContraArmor,pos:[200,400]},{tex:"#princess.png",type:Crystal,pos:[850,400]}]}],GameScene=cc.Scene.extend({_room:null,_downRoom:null,_hero:null,_enemyLayer:null,_uiLayer:null,_breaking:!1,enemies:[],crystals:[],_level:-1,itemTypes:[],itemProbs:[],enemyCount:0,objs:[],ctor:function(){this._super();cc.spriteFrameCache.addSpriteFrames(res.items_plist,res.items_png);this._hero=
new Hero;this.addChild(this._hero,3);this._hero.x=cc.winSize.width/2;this._hero.y=cc.winSize.height/2;this.levelUp();this._room=new RoomLayer(this._hero,this.itemTypes,this.itemProbs);this.addChild(this._room,1);this._enemyLayer=new EnemyLayer(this._hero);this._enemyLayer.width=CFG.width;this._enemyLayer.height=CFG.height;this.addChild(this._enemyLayer,10);this.addEnemies(this.enemyCount);this.initObjs();this.scheduleUpdate();cc.eventManager.addListener({event:cc.EventListener.TOUCH_ALL_AT_ONCE,onTouchesEnded:function(a,
b){}},this)},levelUp:function(){var a,b;if(this._level<Levels.length-1&&(this._level++,a=Levels[this._level]))for(b in a)this[b]=a[b]},initObjs:function(){var a=this.objs,b,c,d,e;b=0;for(c=a.length;b<c;++b)d=a[b],e=d.node=new d.type(d.tex),e.x=d.pos[0],e.y=d.pos[1],e instanceof Crystal?this.addCrystal(e):this.addObject(e)},addCrystal:function(a,b){this._room._itemLayer.addChild(a,b||CFG.objZ);this.crystals.push(a)},removeCrystal:function(a){var b=this.crystals.indexOf(a);this.crystals.splice(b,1);
this._room._itemLayer.removeChild(a,!0)},getCrystal:function(a){var b=this;1==this.crystals.length?this.scheduleOnce(this.breakDown,0):this.scheduleOnce(function(){b.removeCrystal(a)},0)},addObject:function(a,b){this._room.addChild(a,b||CFG.objZ)},removeObject:function(a){this._room.removeChild(a,!0)},addEnemies:function(a){for(var b=0;b<a;b++)this._enemyLayer.addEnemy(Enemy);this.enemies=this._enemyLayer.children},update:function(a){if(!this._breaking){var b=this.children,c,d,e,f=this._downRoom;
c=0;for(d=b.length;c<d;++c)e=b[c],e!=f&&e.update&&e.update(a)}},cleanUp:function(){var a,b;a=0;for(b=this.crystals.length;a<b;++a)this._room.removeChild(this.crystals[a],!0);this.crystals=[];this.objs=[]},breakDown:function(){this._breaking=!0;this.cleanUp();this.levelUp();this._downRoom&&this._downRoom.removeFromParent(!0);this._downRoom=this._room;this._room=new RoomLayer(this._hero,this.itemTypes,this.itemProbs);this._room.scaleX=CFG.inScaleX;this._room.scaleY=CFG.inScaleY;this.addChild(this._room,
0);this.initObjs();this._downRoom._tiledLayer.breakDown();this._downRoom.runAction(cc.sequence(cc.delayTime(CFG.tileBreakTime),cc.callFunc(this.preScale,this),cc.scaleTo(1,CFG.outScaleX,CFG.outScaleY),cc.callFunc(this.transitionDone,this)));this._hero.fall()},preScale:function(){this._downRoom.cleanUp();this._room.runAction(cc.scaleTo(1,1));this._hero.falling()},transitionDone:function(){this._room.zIndex=1;this._downRoom.zIndex=2;this.addEnemies(this.enemyCount);this._hero.landed();this._breaking=
!1}});GameScene.instance=null;cc.game.onStart=function(){cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(CFG.width,CFG.height,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){GameScene.instance=new GameScene;cc.director.runScene(GameScene.instance)},this)};cc.game.run();